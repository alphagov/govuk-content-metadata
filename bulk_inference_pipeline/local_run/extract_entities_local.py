...
Requirements:
- Access the GCP project cpto-content-metadata
...
folder, from the `bulk_inference_pipeline` directory you can run:
...
if __name__ == "__main__":  # noqa: C901
    ...
    from src.utils import load_model, chunks, stream_from_bigquery

    with open("bulk_inference_config.yml", "r") as file:
        config = yaml.safe_load(file)

    parser = argparse.ArgumentParser(
        description="Run local_run.infer_entities_local.py"
    )
